...
// TODO. 修改XML Document文件中属性的值
public class W3cDocumentProject {
    ...
    private void adaptHbmFileWithEntityNameTag(Document domDocument) {
        List<String> elementTagNames = Arrays.asList("class", "subclass", "joined-subclass", "union-subclass");
        Node packageNode = domDocument.getElementsByTagName("hibernate-mapping")
                .item(0).getAttributes().getNamedItem("package");
